...
public class JdbcMealRepositoryImpl implements MealRepository {
    ...
    @Autowired
    public JdbcMealRepositoryImpl(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedTemplate, DataSource dataSource) {
    ...
    public Meal save(Meal meal, int userId) {
        ...
        if (meal.isNew()){
            ...
            int rows = namedTemplate.update("UPDATE meals SET datetime=:datetime, description=:description," +
