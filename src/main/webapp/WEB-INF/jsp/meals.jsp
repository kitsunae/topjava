    ...
    <div class="container-fluid col-md-offset-8">
        <form id="filter-form">
            ...
            <div class="btn-group">
                ...
                <button class="btn btn-default" type="reset" onclick="updateTable()"><spring:message code="meals.cancel"/></button>
            </div>
        </form>
    </div>
    <div class="jumbotron">
                ...
                <table class="table table-striped display" id="datatable">
                    ...
                    <c:forEach items="${meals}" var="meal">
                        ...
                        <tr class="${meal.exceed ? 'exceeded' : 'normal'}">
                            ...
                            <td>${meal.calories}</td>
                            <td><a class="btn btn-xs btn-primary edit"><spring:message code="common.update"/>
                                <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                            </a></td>
                            <td><a class="btn btn-xs btn-danger delete" id="${meal.id}"><spring:message code="common.delete"/>
